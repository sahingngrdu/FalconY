  ...
  run: async (client, interaction) => {
    try {
      const musicCommandsEmbed = new EmbedBuilder()
        ...
        .setImage(`https://e0.pxfuel.com/wallpapers/18/836/desktop-wallpaper-fenerbahce-s-k-background.jpg`); 
      ...
      const button1 = new ButtonBuilder()
        .setLabel('YouTube')
        .setURL('https://www.youtube.com/watch?v=NJ2TkBrWA04')
        .setStyle(ButtonStyle.Link);

      const button2 = new ButtonBuilder()
        .setLabel('Discord')
        .setURL('https://discord.gg/Z3cv7ueK')
        .setStyle(ButtonStyle.Link);
