...
const { colorFetch } = require("../fn/colorFetch");
 ...
 //canvas.GlobalFonts.registerFromPath(`ajju/st/font/notosans-black.ttf`, "noto-sans");
 //canvas.GlobalFonts.registerFromPath(`ajju/st/font/notoemoji-bold.ttf`, "noto-emoji");
 //canvas.GlobalFonts.registerFromPath(`ajju/st/font/notosans-kr-black.ttf`, "noto-sans-kr");
 //canvas.GlobalFonts.registerFromPath(`ajju/st/font/Space.ttf`, "space");

 canvas.GlobalFonts.registerFromPath(`node_modules/muzicard/ajju/st/font/KaushanScript-Regular.ttf`, "mayank");
 canvas.GlobalFonts.registerFromPath(`node_modules/muzicard/ajju/st/font/circularstd-black.otf`, "circular-std");
 canvas.GlobalFonts.registerFromPath(`node_modules/muzicard/ajju/st/font/notosans-jp-black.ttf`, "noto-sans-jp");
 canvas.GlobalFonts.registerFromPath(`node_modules/muzicard/ajju/st/font/notosans-black.ttf`, "noto-sans");
 canvas.GlobalFonts.registerFromPath(`node_modules/muzicard/ajju/st/font/notoemoji-bold.ttf`, "noto-emoji");
 canvas.GlobalFonts.registerFromPath(`node_modules/muzicard/ajju/st/font/notosans-kr-black.ttf`, "noto-sans-kr");
 canvas.GlobalFonts.registerFromPath(`node_modules/muzicard/ajju/st/font/Chewy-Regular.ttf`, "chewy");
 canvas.GlobalFonts.registerFromPath(`node_modules/muzicard/ajju/st/font/CaveatBrush-Regular.ttf`, "ravyy");
 canvas.GlobalFonts.registerFromPath(`node_modules/muzicard/ajju/st/font/Satisfy-Regular.ttf`, "sneha");
 canvas.GlobalFonts.registerFromPath(`node_modules/muzicard/ajju/st/font/Space.ttf`, "space");
 canvas.GlobalFonts.registerFromPath(`node_modules/muzicard/ajju/st/font/AkayaTelivigala-Regular.ttf`, "spacex");
 canvas.GlobalFonts.registerFromPath(`node_modules/muzicard/ajju/st/font/BerkshireSwash-Regular.ttf`, "ariana");
...
class muzicard {
    ...
    async build() {
        ...
        if (this.theme == 'classic') {
            ...
            const background = await canvas.loadImage(`https://arjunreddy.sirv.com/Images/Muzicard/Neon%20Theme.png`);
            ...
            const bg2 = await canvas.loadImage("https://arjunreddy.sirv.com/Images/Muzicard/Round%20Thumb.png")
            ...
            ctx.fillRect(0, 0, 1280, 450);
            ctx.fillStyle = `#${validatedColor}`;
            ctx.font = `110px chewy, chewy, noto-emoji, chewy, chewy`;
            ctx.fillText(this.name, 490, 200); 

            ctx.fillStyle = '#b8b8b8';
            ctx.font = `55px chewy, chewy, chewy, noto-emoji chewy`;
           ...
           ctx.drawImage(thumbnailCanvas, 70, 50, 350, 350);
            ...
            const background = await canvas.loadImage(`https://arjunreddy.sirv.com/Images/Muzicard/Anime%20Theme.png`);
           ...
           ctx.drawImage(thumbnailCanvas, 70, 50, 350, 350);
            ...
            const background = await canvas.loadImage(`https://arjunreddy.sirv.com/Images/Muzicard/Animes%20Theme.png`);
           ...
           thumbnailCtx.arcTo(0, thumbnailCanvas.height, 0, 0, cornerRadius2);
            ...
            // Apply fade effect between background and upper parts
            const gradient = ctx.createLinearGradient(0, 0, 0, 450);
            gradient.addColorStop(0, 'rgba(0,0,0,0.5)'); // Fully transparent
            gradient.addColorStop(0.5, 'rgba(0,0,0,0.5)'); // 50% transparent
            gradient.addColorStop(1, 'rgba(0,0,0,0.5)'); // Fully opaque

            ctx.fillStyle = gradient;
            ctx.fillRect(0, 0, 1280, 450);
            ctx.fillStyle = `#${validatedColor}`;
            ctx.font = `80px ravyy,  noto-emoji,`;
            ctx.fillText(this.name, 490, 200); 

            ctx.fillStyle = '#b8b8b8';
            ctx.font = `40px ravyy, noto-emoji`;
            ctx.fillText(this.author, 510, 260); 
           ...
           ctx.drawImage(thumbnailCanvas, 70, 50, 350, 350);
            ...
            ctx.fillRect(0, 0, 1280, 450);
            ctx.fillStyle = `#${validatedColor}`;
            ctx.font = `90px ravyy,  noto-emoji,`;
            ctx.fillText(this.name, 450, 200); 
            ...
            const background = await canvas.loadImage(`https://arjunreddy.sirv.com/Images/Muzicard/3pae4flbryaputyl.jpg`);
           ...
           ctx.drawImage(thumbnailCanvas, 70, 50, 350, 350);
            ...
            ctx.fillRect(0, 0, 1280, 450);
            ctx.fillStyle = `#${validatedColor}`;
            ctx.font = `90px spacex,  noto-emoji,`;
            ctx.fillText(this.name, 450, 200); 

            ctx.fillStyle = '#b8b8b8';
            ctx.font = `40px spacex, noto-emoji`;
            ctx.fillText(this.author, 460, 260); 

            ctx.fillStyle = '#fff';
            ctx.font = '30px spacex';
            ctx.fillText(validatedStartTime, 450, 380); 
           ...
           ctx.drawImage(thumbnailCanvas, 70, 50, 350, 350);
            ...
            const background = await canvas.loadImage(`https://arjunreddy.sirv.com/Images/Muzicard/SPECIAL.png`);
            ...
            ctx.fillRect(0, 0, 1280, 450);
            ctx.fillStyle = `#${validatedColor}`;
            ctx.font = `110px sneha, sneha, noto-emoji, sneha, sneha`;
            ctx.fillText(this.name, 490, 200); 

            ctx.fillStyle = '#b8b8b8';
            ctx.font = `55px sneha, sneha, sneha, noto-emoji sneha`;
            ctx.fillText(this.author, 510, 260); 
           ...
           ctx.drawImage(thumbnailCanvas, 70, 50, 350, 350);
            ...
            ctx.fillRect(0, 0, 1280, 450);
            ctx.fillStyle = `#${validatedColor}`;
            ctx.font = `90px sneha,  noto-emoji,`;
            ctx.fillText(this.name, 450, 200); 

            ctx.fillStyle = '#b8b8b8';
            ctx.font = `40px sneha, noto-emoji`;
            ctx.fillText(this.author, 460, 260); 
            ...
            const background = await canvas.loadImage(`https://arjunreddy.sirv.com/Images/Muzicard/bluesky.jpg`);
            ...
            ctx.fillRect(0, 0, 1280, 450);
            ctx.fillStyle = `#${validatedColor}`;
            ctx.font = `90px mayank,  noto-emoji,`;
            ctx.fillText(this.name, 450, 200); 

            ctx.fillStyle = '#b8b8b8';
            ctx.font = `40px mayank, noto-emoji`;
            ctx.fillText(this.author, 460, 260); 

            ctx.fillStyle = '#fff';
            ctx.font = '30px mayank';
            ctx.fillText(validatedStartTime, 450, 380); 
            ...
            ctx.fillRect(0, 0, 1280, 450);
            ctx.fillStyle = `#${validatedColor}`;
            ctx.font = `110px mayank, mayank, noto-emoji, mayank, mayank`;
            ctx.fillText(this.name, 490, 200); 

            ctx.fillStyle = '#b8b8b8';
            ctx.font = `55px mayank, mayank, mayank, noto-emoji mayank`;
            ctx.fillText(this.author, 510, 260); 
           ...
           ctx.drawImage(thumbnailCanvas, 70, 50, 350, 350);
            ...
            throw new Error('Inavlid Theme, must be  one of:  "classic", "dynamic", "neon", "neonx", "ravyy", "ravyyx", "anime", "animex", "space", "spacex", "bluesky", "blueskyx"');
        }
    }
}

module.exports = { muzicard };